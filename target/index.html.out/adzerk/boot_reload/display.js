...
var attr = cljs.core.nth.call(null,vec__9732,(0),null);
var v = cljs.core.nth.call(null,vec__9732,(1),null);
...
var args9733 = [];
var len__7513__auto___9736 = arguments.length;
var i__7514__auto___9737 = (0);
while(true){
if((i__7514__auto___9737 < len__7513__auto___9736)){
args9733.push((arguments[i__7514__auto___9737]));

var G__9738 = (i__7514__auto___9737 + (1));
i__7514__auto___9737 = G__9738;
continue;
} else {
}
break;
...
var len__7513__auto___9741 = arguments.length;
var i__7514__auto___9742 = (0);
while(true){
if((i__7514__auto___9742 < len__7513__auto___9741)){
args__7520__auto__.push((arguments[i__7514__auto___9742]));

var G__9743 = (i__7514__auto___9742 + (1));
i__7514__auto___9742 = G__9743;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9740){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9740));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9744){
var map__9748 = p__9744;
var map__9748__$1 = ((((!((map__9748 == null)))?((((map__9748.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9748.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9748):map__9748);
var data = map__9748__$1;
var message = cljs.core.get.call(null,map__9748__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9748__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9748__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9750 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9750,goog.events.EventType.CLICK,((function (G__9750,map__9748,map__9748__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9750,map__9748,map__9748__$1,data,message,line,file))
);

return G__9750;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9751){
var map__9755 = p__9751;
var map__9755__$1 = ((((!((map__9755 == null)))?((((map__9755.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9755.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9755):map__9755);
var data = map__9755__$1;
var message = cljs.core.get.call(null,map__9755__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9755__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9755__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9757 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__9757,goog.events.EventType.CLICK,((function (G__9757,map__9755,map__9755__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9757,map__9755,map__9755__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9758){
var map__9762 = p__9758;
var map__9762__$1 = ((((!((map__9762 == null)))?((((map__9762.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9762.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9762):map__9762);
...
var G__9764 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9764,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9764,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9765){
var map__9768 = p__9765;
var map__9768__$1 = ((((!((map__9768 == null)))?((((map__9768.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9768.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9768):map__9768);
var messages = map__9768__$1;
var warnings = cljs.core.get.call(null,map__9768__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9768__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9768,map__9768__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9768,map__9768__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9768,map__9768__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9768,map__9768__$1,messages,warnings,exception))
;
